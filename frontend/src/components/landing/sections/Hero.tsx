...
import { ArrowRight, PlayCircle, Sparkles, Bot, ShoppingBag, Truck, BarChart3 } from "lucide-react";
...
const dashCards = [
  ...
  { icon: BarChart3, label: "Analytics", value: "GMV +24% MoM", tone: "from-green-500/20 to-lime-500/10" },
];

export function Hero() {
  return (
    <section id="top" className="relative pt-32 pb-20 sm:pt-40 sm:pb-28 bg-gradient-hero overflow-hidden">
      {/* floating particles */}
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute -top-40 -left-20 h-[420px] w-[420px] rounded-full bg-primary/20 blur-3xl" />
        <div className="absolute top-20 -right-20 h-[520px] w-[520px] rounded-full bg-accent/20 blur-3xl" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          >
            ...
            <span className="text-gradient">yangi avlod</span> agro ekotizimi
          </motion.h1>
          ...
          >
            Fermer, xaridor va logistika xizmatlarini yagona aqlli platformada
            birlashtiramiz.
          </motion.p>
          ...
          >
            <div>
              <div className="font-bold text-foreground text-xl">100K+</div>
              Fermerlar
            </div>
            <div className="h-8 w-px bg-border" />
            <div>
              <div className="font-bold text-foreground text-xl">10M+</div>
              GMV
            </div>
            <div className="h-8 w-px bg-border" />
            <div>
              <div className="font-bold text-foreground text-xl">99.9%</div>
              Uptime
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="relative rounded-3xl glass p-5 shadow-neon">
            <div className="flex items-center gap-1.5 mb-4">
              <span className="h-2.5 w-2.5 rounded-full bg-red-400/60" />
              <span className="h-2.5 w-2.5 rounded-full bg-yellow-400/60" />
              <span className="h-2.5 w-2.5 rounded-full bg-green-400/60" />
              <span className="ml-3 text-xs text-muted-foreground">agroverse.ai/dashboard</span>
            </div>

            <div className="rounded-2xl bg-card/70 p-4">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <div className="text-xs text-muted-foreground">Bugungi tahlil</div>
                  <div className="text-lg font-bold">AI Insights</div>
                </div>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-[11px] text-muted-foreground">AI tavsiya</div>
                <div className="text-sm font-semibold">+18% hosil prognozi</div>
              </div>
            </div>
          </motion.div>
        </motion.div>
